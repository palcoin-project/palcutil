...
/*
This test file is part of the palcutil package rather than than the
palcutil_test package so it can bridge access to the internals to properly test
...
import (
	...
	"github.com/palcoin-project/palcutil/bech32"
