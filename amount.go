...
func (u AmountUnit) String() string {
	...
	case AmountSatoshi:
		return "Palestino"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " PALC"
	}
}
...
// See GoDoc for example: http://godoc.org/github.com/palcoin-project/palcutil#example-Amount
func NewAmount(f float64) (Amount, error) {
	...
	case math.IsInf(f, 1):
		fallthrough
	case math.IsInf(f, -1):
		return 0, errors.New("invalid palcoin amount")
	}
