...
import (
	...
	"github.com/palcoin-project/palcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    palcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash  { return c.TxHash }
func (c *TestCoin) Index() uint32          { return c.TxIndex }
func (c *TestCoin) Value() palcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value palcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = palcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = palcutil.NewTxFromBytes(testSimpleCoinTxBytes)
