...
// Tx returns a wrapped transaction (palcutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (palcutil.Tx) for all
...
// instead provides easy access to wrapped versions (palcutil.Tx) of them.
